...
CAFFE=/home/sy/caffe/build/tools/caffe
#其默认的目录是caffe-reid目录，MODEL下有train.proto等文件
MODEL=/home/sy/Stamp294/log
...
GLOG_log_dir=$MODEL $CAFFE train \
    --gpu $gpu \
    --solver /home/sy/Stamp294/prototxt/resnet50_solver.prototxt \
    --weights /home/sy/ResNet-50-model.caffemodel
